 ...
 , {
   name: 'Charley',
   photos: './photos/charley.png',
   gif: './photos/gifs/charleyGif.gif',
   ...
   name: 'chattyApp',
   photos: './photos/chattyApp.png',
   gif: './photos/gifs/chattyGif.gif',
   ...
   keyFeatures: ['Express.js', 'Node.js', 'React.js', 'WebSockets', 'Webpack'],   
   linkToProject: 'test4',
   ...
   gif: './photos/gifs/pollandGif.gif',
