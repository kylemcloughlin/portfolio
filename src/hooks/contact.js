...
function Contact() {
  ...
  return (
    ...
    <div class='contact-holder'>
      <p class='contact-para'>Please email me at <a id='github'onClick={() => {window.open('mailto:kylemcloughlindev@gmail.com?subject=Mail from Our Site')}}>kylemcloughlindev@gmail.com</a>.</p>
